...
def main():
    ...
    # draw frame numbers on top left
    output_video_frames = [cv2.putText(frame, str(i), (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2) for i, frame in enumerate(output_video_frames)]
